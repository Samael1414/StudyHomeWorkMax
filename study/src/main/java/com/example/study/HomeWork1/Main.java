...
public class Main {
    ...
    public static void nestedPool() {
        ...
        //эта задача вааще не то. помнишь как выглядит таблица умножения? посмотри как она визуально выглядит. т.е. если ты выбираешь 3 то в результате должно быть типа 1 * 1 = 7
        //1 * 2 = 14
        //1 * 3 = 21
        //1 * 4 = 28 потом точно так же для цифры 2 а потом для 3
